        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceFilter = table.Column<string>(type: "text", nullable: true),
                    Frequency = table.Column<string>(type: "text", nullable: false),
                    EmailEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastCheckedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastMatchCount = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedSkills = table.Column<string>(type: "text", nullable: true),
                    Level = table.Column<string>(type: "text", nullable: true),
                    TargetLocation = table.Column<string>(type: "text", nullable: true),
                    ExpectedMinSalary = table.Column<int>(type: "integer", nullable: true),
                    ExpectedMaxSalary = table.Column<int>(type: "integer", nullable: true),
                    LastCvAnalysis = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_DateScraped",
                table: "JobPostings",
                column: "DateScraped");

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_Source",
                table: "JobPostings",
                column: "Source");
